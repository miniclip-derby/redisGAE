...
// Float64 returns a float64 representing the value of the Resp. Only valued for
...
// pre-allocated byte buffer for encoding integers (expected to have a length of
